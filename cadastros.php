...
<script>
    ...
    document.getElementById('fornecedorLink').addEventListener('click', function() {
        ...
        document.getElementById('cadastro-container').classList.remove('');
    });

    document.getElementById('funcionarioLink').addEventListener('click', function() {
        mostrarCadastro('funcionario');
        document.getElementById('cadastro-container').classList.add('funcionario-ativo');
        document.getElementById('cadastro-container').classList.add('container-padrao'); // Adicione essa linha para garantir que a classe container-padrao também esteja presente
    });
    ...
    function mostrarCadastro(cadastroSelecionado) {
        ...
        if ((cadastroSelecionado === 'funcionario') || (cadastroSelecionado === 'fornecedor')) {
            document.getElementById('cadastro-container').style.top = '70%';
        }else {
            document.getElementById('cadastro-container').style.top = '55%';
        }
    }
    mostrarCadastro('cliente')
